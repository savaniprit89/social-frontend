            ...
            <ol className="carousel-indicators" style={{zIndex: 1}}>
                {
                    images.map((img, index) => (
                        ...
                        data-slide-to={index} className={isActive(index)} style={{backgroundColor:"black"}} />
                    ))
                }
                    ...
                    images.map((img, index) => (
...

                        {
                            img.url.match(/video/i)
                                ?  <video controls src={img.url} className="d-block w-100" alt={img.url} style={{height:"400px",objectFit:"contain"}} /> :  <img src={img.url} className="d-block w-100" alt={img.url} style={{height:"400px",objectFit:"contain"}} />
                        }
