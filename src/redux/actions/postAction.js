...
export const getposts =  (token)=>async (dispatch) =>{
    ...
    export const getPost=({detailpost,id,auth}) => async (dispatch) =>{
        ...
        const msg = {
            id: post._id,
            text: 'added a new post.',
            recipients: res.data.Npost.user.followers,
            url: `/post/${post._id}`,
        }
        dispatch(removeNotify({msg, auth, socket}))
        ...
        export const savePost=({post,auth}) => async (dispatch) =>{
            ...
            dispatch({type:globaTypes.AUTH,payload:{...auth,user:newUser}});
                ...
                const res=await  patchDataAPI(`savepost/${post._id}`,null,auth.token)
console.log(res.data)
            ...
            export const unsavePost=({post,auth}) => async (dispatch) =>{
                ...
                dispatch({type:globaTypes.AUTH,payload:{...auth,user:newUser}});
                    ...
                    const res=await  patchDataAPI(`unsavepost/${post._id}`,null,auth.token)
    console.log(res.data)
